...
texts = [["Получить промокод очень просто: ответь на два простых вопроса и оставь свою электронную почту!"], [
...
[
	"Знаешь ли ты, что в дни Startup Village 21-22 мая у тебя будет возможность пообщаться с представителями Газпромбанка и партнёров?", 
...
function exit(){
	...
	$('#finish-text')[0].innerText = "Спасибо за ваши ответы! Чтобы получить промокод, оставьте свой адресс электронной почты";
